...
sEddyProc$methods(
	sEstUstarThreshold = structure(function(
	  ...
	  ## OM, TW
		...
		,seasonFactor.v = createSeasonFactorMonthWithinYear(ds$sDateTime) ##<< factor for subsetting times see details 
...
sEddyProc$methods(
		...
		,seasonFactor.v = createSeasonFactorMonthWithinYear(ds$sDateTime)  ##<< factor of seasons to split
...
sEddyProc$methods(
		...
		,seasonFactor.v = as.factor(createSeasonFactorMonthWithinYear(sDATA$sDateTime))   ##<< factor of seasons to split
