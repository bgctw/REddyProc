...
(uStarTh <- EddyProc.C$sEstUstarThold(seasonFactor = seasonFactor))
...
EddyProc.C$sMDSGapFillAfterUstar(
  'NEE', FillAll.b = FALSE, uStarTh = uStarScens, Verbose.b = FALSE)
```		
...
EddyProc.C$sSetUstarScenarios(uStarScens)
```	
...
resUStar <- EddySetups.C$sEstUstarThold(
