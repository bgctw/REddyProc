...
The output reports annually aggregated uStar estimates of `r if (!is_check) signif(unlist(EddyProc.C$sGetUstarScenarios()[1,2]),2)` for 
the orignal data and `r if (!is_check) signif(unlist(EddyProc.C$sGetUstarScenarios()[1,3:5]),2)` for lower, median, 
