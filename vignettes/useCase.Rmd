...
.tmp.f <- function(){
  ...
  #), Year == 1998)
  ds$DoY[ds$DoY == 366] <- 1
  dss <- EddyDataWithPosix <- fConvertTimeToPosix(ds, 'YDH',Year.s = 'Year'
...
EProc$sPlotFingerprint('NEE_orig', Dir.s = "plots_fingerprint", Format.s = "png")
EProc$sPlotFingerprint('NEE_low', Dir.s = "plots_fingerprint", Format.s = "png")
EProc$sPlotFingerprint('NEE_median', Dir.s = "plots_fingerprint", Format.s = "png")
EProc$sPlotFingerprint('NEE_upper', Dir.s = "plots_fingerprint", Format.s = "png")
