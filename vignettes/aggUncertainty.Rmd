...
Take care of estimating the autocorrelation function on a dataset with
equidistant time steps. Since, in the above code the autocorrelation 
function was supplied as
an argument to `computeEffectiveNumObs`, filtering was legitimate.
